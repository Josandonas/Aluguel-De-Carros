...
<body id="page-top">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Básicos C/Sem Ar-condicionado</h2>
        </div>
      </div>
        ...
        <a href="mostrar.html"><button type="button" class="btn btn-info btn-block btn-xl text-uppercase js-scroll-trigger"> Voltar ao Topo da Página</button></a>
  </section>


  <section id="intermediarios">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Intermediarios C/Sem Ar-condicionado</h2>
        </div>
      </div>
            <div id="carousel-teste" class="carousel slide carousel-fade" data-ride="carousel">
              <div class="carousel-inner">
                  <ol class="carousel-indicators">
                    <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
                    <li data-target="#carouselExampleIndicators" data-slide-to="1"></li>
              ...
              <a class="carousel-control-prev" href="#carousel-teste" role="button" data-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
              </a>
              <a class="carousel-control-next" href="#carousel-teste" role="button" data-slide="next">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="sr-only">Next</span>
              </a>
            </div>
 ...
 <section id="luxo" class="background-color">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Luxo</h2>
        </div>
      </div>
            ...
            <div id="carousel-determinante" class="carousel slide carousel-fade" data-ride="carousel">
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <img class="d-block w-100" src="./img/carluxo/porscheBoxter.jpg">
                  <div class="carousel-caption d-none d-md-block">
                      <h5 id="myDiv" style="background-color:orange;">PORSCHE 718 </h5>
                      <p id="myDiv" style="background-color:orange;">R$ 200,00 por dia</p>
                  </div>
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="./img/carluxo/lamborghiniUrus.jpg" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h5 id="myDiv" style="background-color:orange;">Lambhorghini URUS</h5>
                      <p id="myDiv" style="background-color:orange;">R$ 200,00 por dia</p>
                  </div>
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="./img/carluxo/maybacheElero.jpg" alt="Third slide">
                  <div class="carousel-caption d-none d-md-block">
                      <h5 id="myDiv" style="background-color:orange;">Maybach Landaulet Motor: 6,0 V12 (612 cv)</h5>
                      <p id="myDiv" style="background-color:orange;">R$ 200,00 por dia</p>
                  </div>
                </div>
              </div>
