...
<form class="container" method="POST" action="/garagem/carro/cadastro/" enctype="multipart/form-data">
    ...
    <fieldset>
		...
		<div class="form-group">          
		  <label>Nome: </label>
			<input type="text" name="nome" class="form-control" placeholder="Digite aqui o nome do veículo" required>
    </div>

    <div class="form-group">          
		  <label>Modelo: </label>
			<input type="text" name="modelo" class="form-control" placeholder="Digite aqui o modelo do veículo" required>
    </div>
        ...
        <option value="3">Carro intermediario Manual</option>
				<option value="1">Básico Manual</option>
	...
	<center>
		...
		<label>Dimensões: </label>
				<div class="input-group col-md-3">
					<input type="text" name="dimensao" id="Dimensões" class="form-control" placeholder="Digite aqui a largura x altura" required>
				</div>
			</div>	
    ...
    <div class="form-group">
          <label>Confirme a garagem: </label>
			<input type="text" name="agencia" id="agencia" class="form-control" placeholder="Digite aqui o CNPJ da garagem" required>
    </div>
