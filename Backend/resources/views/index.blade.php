...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="index.blade.php">Home-Page</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
           ...
           <li class="nav-item">
            <a class="nav-link js-scroll-trigger" data-toggle="modal" data-target="#cadasgaragem" >Cadastro Garagem</a>
          </li>    
    ...
    <div class="container">
      ...
      <div class="row text-center">
        ...
        <div class="col-md-4">
          ...
          <h4 class="service-heading">Segurança no pagamento</h4>
          <p class="text-muted">Você faz um negócio com uma marca reconhecida pela excelência e valorização do cliente.</p>
        </div>
      </div>
    </div>
  </section>
...
<!-- Modal form cadastro garagem -->
<div class="modal fade" id="cadasgaragem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" >Cadastre-se</h5>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nome" placeholder="Nome da Garagem" ng-model="cadastroNome">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputEmail">Email:</label> <input type="email" class="form-control" id="email" placeholder="exemplo@exemplo.com" ng-model="cadastroEmail">
                    </div>
            ...
            <!-- footer -->
            <div class="modal-footer">
			  <a href="controlegaragem.html"> Já possui uma garagem?</a>
                    <button type="button" id="btnCadastrar" class="btn btn-success btn-block" data-loading-text="Cadastrando...">Salvar Cadastro</button>
            </div>
            <!-- end footer -->
...
<!--  end-Modal -->
<!--  end-Modal form cadastro garagem  -->
