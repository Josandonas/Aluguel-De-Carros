                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <p>Potência: 77 Cavalos</p>
                      <p>Aceleração: De 0 a 100 km/h em 12,5 segundos</p>
                      <p>Dimensões: 1.636 Metros Largura x  1.480 metros Altura</p>
                      <p>Motor: 3 cilindros Flex </p>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <h5>A diária é equivalente: R$ 35,00</h5>
                      <h5>Sem Ar-condicionado</h5>
                      <p>Potência: 80 - 6500 cavalos</p>
                      <p>Aceleração: De 0 a 166 km/h em 13,6 segundos</p>
                      <p>Dimensões: 1,911 metros Largura x  1,525 metros Altura</p>
                      <p>Motor: 1.0 Cilindrada</p>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <h5>A diária é equivalente: R$ 35,00</h5>
                      <h5>Sem Ar-condicionado</h5>
                      <p>Potência: 101 cavalos</p>
                      <p>Aceleração: De 0 a 200 km/h em 12,1 segundos</p>
                      <p>Dimensões: 1.730 Metros de Largura x 1.490 metros de Altura</p>
                      <p>Motor: 1.5 Cilindradas</p>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
